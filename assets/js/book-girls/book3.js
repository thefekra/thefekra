...
const booksDataRight = [
    { imgSrc: '../assets/imgs/32.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/33.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/34.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/35.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/36.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/37.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/38.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/39.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/40.jpg', downloadLink: '' },
    // يمكنك إضافة المزيد من العناصر هنا
];

// الكود الخاص بإنشاء الصناديق في الدف الأيسر
const booksDataLeft = [
    { imgSrc: '../assets/imgs/41.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/42.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/43.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/44.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/45.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/46.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/47.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/48.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/49.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/50.jpg', downloadLink: '' },
