...
const booksDataRight = [
    { imgSrc: '../assets/imgs/1.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/2.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/3.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/img/4.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/5.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/img/6.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/img/7.jpg', downloadLink: '' },
    // يمكنك إضافة المزيد من العناصر هنا
];

// الكود الخاص بإنشاء الصناديق في الدف الأيسر
const booksDataLeft = [
    { imgSrc: '../assets/imgs/8.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/9.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/10.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/11.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/12.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/13.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/14.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/15.jpg', downloadLink: '' },
