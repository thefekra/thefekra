...
const booksDataRight = [
    { imgSrc: '../assets/imgs/girl-asyut/16.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/17.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/18.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/19.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/20.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/21.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/22.jpg', downloadLink: '' },
    // يمكنك إضافة المزيد من العناصر هنا
];

// الكود الخاص بإنشاء الصناديق في الدف الأيسر
const booksDataLeft = [
    { imgSrc: '../assets/imgs/girl-asyut/23.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/24.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/25.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/26.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/27.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/28.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/29.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/30.jpg', downloadLink: '' },
    { imgSrc: '../assets/imgs/girl-asyut/31.jpg', downloadLink: '' },
